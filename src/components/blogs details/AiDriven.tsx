...
const AiDriven = () => {
    return (
        <div className="flex justify-center items-center md:py-[180px] py-24">
            <div className="flex max-md:flex-col container relative max-w-[1140px] max-xl:px-5 gap-y-24">
                <div className="flex flex-col lg:gap-y-[180px] gap-y-20 ">
                    <div className="max-w-[655px]">
                        ...
                        <div className="mt-10 max-lg:mt-8 max-md:mt-5 max-sm:mt-3 rounded-[10px] bg-border !p-[1px]">
                            <div className="!bg-darkBlack p-2.5 max-w-[653px] rounded-[10px] w-full h-full">
                                <Image src={"/assets/images/webp/time-analytics.webp"} width={635} height={550} alt="images" className="pointer-events-none max-lg:max-w-[635px] w-full" />
                            </div>
                        </div>
                    </div>
                    <div className="max-w-[655px]">
                        ...
                        <div className="mt-10 max-lg:mt-8 max-md:mt-5 max-sm:mt-3 rounded-[10px] bg-border !p-[1px]">
                            <div className="!bg-darkBlack p-2.5 max-w-[653px] rounded-[10px] w-full h-full">
                                <Image src={"/assets/images/webp/changing-game.webp"} width={635} height={550} alt="images" className="pointer-events-none max-lg:max-w-[635px] w-full" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="max-w-[485px] w-full flex justify-end">
                    <div className="bg-driven sticky top-5 max-w-[364px] w-full border border-solid border-skyBlue rounded-3xl py-[30px] max-h-[525px]">
                        ...
                        <div className="flex flex-col px-5  gap-y-4">
                            ...
                            {MARKET_HEADING_LIST.map((item,i) => (
                                <p key={i} className="text-white/70 leading-[150%] max-md:text-sm">{item}</p>
                            ))}
                        </div>
                        ...
                        <div className="flex flex-col px-5  gap-y-4">
                            ...
                            {CHANGING_GAME_HEADING_LIST.map((item,i) => (
                                <p key={i} className="text-white/70 leading-[150%] max-md:text-sm"> {item}</p>
                            ))}
                        </div>
                    </div>
