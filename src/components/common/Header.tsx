...
import TradeMarquee from "./TradeMarquee";
...
const Navbar = () => {
    ...
    return (
        <>
            <TradeMarquee />
            <div className="flex justify-center items-center px-5 relative z-10">
                <div className="container max-lg:px-5 box-border border border-dark backdrop-blur-[25px] border-solid mt-4 bg-white/10 flex justify-center items-center md:rounded-[60px] rounded-3xl py-4 max-w-[1220px]">
                    <div className="flex max-w-[1092px] justify-between items-center w-full">
                        ...
                        <div className={`lg:w-3/4 w-full transition-all duration-300 flex justify-between items-center max-lg:justify-center max-lg:!fixed max-lg:!top-0 max-lg:w-full max-lg:h-screen max-lg:bottom-0 max-lg:flex-col max-lg:gap-6 max-lg:bg-black max-lg:z-40 ${open ? "left-0" : "-left-[120%]"}`} >
